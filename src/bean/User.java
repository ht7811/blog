...
public class User {
	...
	@Column(type = "VARCHAR(64)", field = "id", primaryKey = true, defaultNull = false)
	private String id; 			// 主键
	
	@Column(type = "VARCHAR(60)", field = "username")
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", headerPic=" + headerPic
